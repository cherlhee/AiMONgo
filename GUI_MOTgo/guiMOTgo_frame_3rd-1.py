...
# guiMOTgo_frame_3rd-1.py - to write automatically the ai-results to the right frame; to make AI-function to recognize person;
...
class MyGui:
    ...
    def __main__(self):
        ...
        lblHi = Label(mainRight_TopFrame, text='PEOPLE COUNT :')
        lblHi.pack()

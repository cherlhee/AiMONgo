# guiMOTgo_frame_ver3-2.py - to use ai to count people;
# connect automatically the right entry;to make AI-function to recognize person;
...
class MyGui:
    ...
    def countPeopleYolo3(self):
        ...
        # to load the image file chosen by mouse click;
        FNAME = loadingFile
        print(FNAME)
        ...
        # to write people number to entry widgets
        etrRightframe_countPeople.delete(0, END)
        # etrRightframe_countPeople.insert(END, str(self.count))
        etrRightframe_countPeople.insert(END, str(countNumPeople))
    ...
    def __main__(self):
        ...
        btnPlay = Button(topFrame, image=iconPlay, command=self.countPeopleYolo3)
